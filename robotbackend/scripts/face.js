...
// https://developer.mozilla.org/en-US/docs/Web/SVG/Tutorial/Paths
  ...
  Face.parameters = {
    eyeOutlineThickness: 8.6,
    eyeShapeRatio: 1.2165,
    eyeOutlineColor: "#cbd7ff",
    hasReflection: true,
    hasInnerPupil: false,
    hasEyelid: true,
    hasBlinking: true,
    backgroundColor:"#dce6ff",
    eyeCenterDistPercent:28,
    eyeYPercent:44,
    isLEDEyes:0,
    /* V1 style eyes*/
    eyeOuterRadiusPercent:5,
    eyeInnerRadiusPercent:128.8,
    eyeOuterColor:"#cbd7ff",
    eyeInnerColor:"#000000",
    eyelidOffset: -13,
    hasEyeLines:0,
    eyeLineStrokeWidth:0,
    hasPupil:1,
    eyePupilRadius: 10,
    eyePupilRadiusPercent: 90,
